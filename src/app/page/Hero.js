...
const Hero = () => {
  return (
    <div className=' h-screen  hero '>
      ...
      <div className=' border border-red   text-white max-w-2xl  bg-[url("/Skye.png")]  '>
       ...
       >
        ...
        <p className='font-[20] font-[600] 
font-style: italic   '>30+ Years in Business (Oil & Gas, Real Estate, Farming, Media, Fashion)
